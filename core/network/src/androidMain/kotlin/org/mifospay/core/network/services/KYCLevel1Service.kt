...
interface KYCLevel1Service {
    ...
    fun addKYCLevel1Details(
        ...
        @Body kycLevel1Details: org.mifospay.core.model.entity.kyc.KYCLevel1Details,
    ): Observable<GenericResponse>

    @GET(ApiEndPoints.DATATABLES + "/kyc_level1_details/{clientId}")
    fun fetchKYCLevel1Details(@Path("clientId") clientId: Int): Observable<List<org.mifospay.core.model.entity.kyc.KYCLevel1Details>>
