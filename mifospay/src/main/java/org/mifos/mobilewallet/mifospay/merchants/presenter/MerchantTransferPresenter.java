                ...
                new UseCase.UseCaseCallback<FetchAccount.ResponseValue>() {
                    ...
                    public void onSuccess(FetchAccount.ResponseValue response) {
                        ...
                        if (transferAmount > response.getAccount().getBalance()) {
                            mMerchantTransferView.showToast(mMerchantTransferView.getContext().getString(R.string.insufficient_balance));
                        } else {
                    ...
                    public void onError(String message) {
                        mMerchantTransferView.hideSwipeProgress();
                        mMerchantTransferView.showToast(mMerchantTransferView.getContext().getString(R.string.error_fetching_balance));
                    }
                });
    }
