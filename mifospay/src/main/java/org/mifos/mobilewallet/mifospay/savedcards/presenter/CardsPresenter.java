...
public class CardsPresenter implements CardsContract.CardsPresenter {
    ...
    public void addCard(Card card) {
        ...
        if (!validateCreditCardNumber(card.getCardNumber())) {
            mCardsView.showToast(mCardsView.getContext().getString(R.string.invalid_credit_card_number));
        ...
        mUseCaseHandler.execute(addCardUseCase, requestValues,
                new UseCase.UseCaseCallback<AddCard.ResponseValue>() {
                    ...
                    public void onSuccess(AddCard.ResponseValue response) {
                        mCardsView.hideProgressDialog();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.card_added_successfully));
                        fetchSavedCards();
                    }
                    ...
                    public void onError(String message) {
                        mCardsView.hideSwipeProgress();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.error_adding_card));
                    }
                });
    }
    ...
    public void editCard(Card card) {
        ...
        mCardsView.showProgressDialog(mCardsView.getContext().getString(R.string.updating_card));
        ...
        mUseCaseHandler.execute(editCardUseCase, requestValues,
                new UseCase.UseCaseCallback<EditCard.ResponseValue>() {
                    ...
                    public void onSuccess(EditCard.ResponseValue response) {
                        mCardsView.hideProgressDialog();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.card_updated_successfully));
                        fetchSavedCards();
                    }
                    ...
                    public void onError(String message) {
                        mCardsView.hideProgressDialog();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.error_updating_card));
                    }
                });
    }
    ...
    public void deleteCard(int cardId) {
        mCardsView.showProgressDialog(mCardsView.getContext().getString(R.string.deleting_card));
        ...
        mUseCaseHandler.execute(deleteCardUseCase, requestValues,
                new UseCase.UseCaseCallback<DeleteCard.ResponseValue>() {
                    ...
                    public void onSuccess(DeleteCard.ResponseValue response) {
                        mCardsView.hideProgressDialog();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.card_deleted_successfully));
                        fetchSavedCards();
                    }
                    ...
                    public void onError(String message) {
                        mCardsView.hideProgressDialog();
                        mCardsView.showToast(mCardsView.getContext().getString(R.string.error_deleting_card));
                    }
                });
    }
