...
public class Constants {
    ...
    public static final int WHITE_BACK_BUTTON = R.drawable.ic_arrow_white_back_24dp;
    public static final int BLACK_BACK_BUTTON = R.drawable.ic_arrow_black_back_24dp;
}
