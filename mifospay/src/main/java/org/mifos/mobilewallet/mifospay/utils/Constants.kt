...
object Constants {
    ...
    const val ADD_CARD = "Please Add Cards"
    const val SEARCH = "Search"
    const val CLOSE = "Close"
    const val EDIT_CLICK = "Edit Clicked"
    const val CARD_NU = "Card Number: "
    const val EDIT_C = "Edit Card"
    const val DELETE_C = "Delete Card"
    const val CANCEL_C = "Cancel"
