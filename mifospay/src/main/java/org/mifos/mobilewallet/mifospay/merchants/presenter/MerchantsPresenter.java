...
import org.mifos.mobilewallet.core.domain.usecase.FetchClientDetails;
import org.mifos.mobilewallet.core.domain.usecase.account.FetchMerchantsSavingsAccounts;
...
public class MerchantsPresenter implements MerchantsContract.MerchantsPresenter {
    ...
    public void fetchMerchants() {
        mUseCaseHandler.execute(mFetchMerchantsSavingsAccountsUseCase,
                new FetchMerchantsSavingsAccounts.RequestValues(),
                new UseCase.UseCaseCallback<FetchMerchantsSavingsAccounts.ResponseValue>() {
                    @Override
                    public void onSuccess(FetchMerchantsSavingsAccounts.ResponseValue response) {
