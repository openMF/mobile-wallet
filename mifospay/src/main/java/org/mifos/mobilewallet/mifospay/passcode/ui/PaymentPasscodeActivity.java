...
public class PaymentPasscodeActivity extends AppCompatActivity implements MifosPassCodeView.
        PassCodeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setText(getString(R.string.send));
    ...
    public void visibilityChange(View view) {
        ...
        if (!mifosPassCodeView.passcodeVisible()) {
            ivVisibility.setColorFilter(
                    ContextCompat.getColor(PaymentPasscodeActivity.this,
                            R.color.light_grey));
        } else {
            ivVisibility.setColorFilter(ContextCompat.getColor(
                            PaymentPasscodeActivity.this,
                            R.color.gray_dark));
        }
    }
