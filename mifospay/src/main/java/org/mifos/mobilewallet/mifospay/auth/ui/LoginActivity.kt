...
class LoginActivity : BaseActivity(), LoginView {
    ...
    private var mLoginPresenter: AuthContract.LoginPresenter? = null
    ...
    private fun handleLoginInputChanged() {
        val usernameContent = etUsername!!.text.toString()
        val passwordContent = etPassword!!.text.toString()
