    ...
    public void updatePassword(String currentPassword, final String newPassword,
        ...
        if (isNotEmpty(currentPassword) && isNotEmpty(newPassword)
            ...
            if (currentPassword.equals(newPassword)) {
                ...
                mEditPasswordView.showError(mEditPasswordView.getContext().getString(R.string.error_passwords_cannot_be_same));
            } else if (isNewPasswordValid(newPassword, newPasswordRepeat)) {
                updatePassword(currentPassword, newPassword);
            } else {
                mEditPasswordView.stopProgressBar();
                mEditPasswordView.showError(mEditPasswordView.getContext().getString(R.string.error_validating_password));
            }
        } else {
            mEditPasswordView.stopProgressBar();
            mEditPasswordView.showError(mEditPasswordView.getContext().getString(R.string.error_fields_cannot_be_empty));
        }
    }
