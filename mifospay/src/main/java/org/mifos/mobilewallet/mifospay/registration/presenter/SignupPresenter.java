...
import org.mifos.mobilewallet.core.domain.usecase.account.CreateSavingsAccount;
...
public class SignupPresenter implements RegistrationContract.SignupPresenter {
    ...
    @Inject
    CreateSavingsAccount createSavingsAccountUseCase;
    @Inject
    ...
    private void createAccount(int clientId, String accountNo) {
        NewAccount newAccount = new NewAccount(clientId, accountNo);

        mUseCaseHandler.execute(createSavingsAccountUseCase,
                new CreateSavingsAccount.RequestValues(newAccount),
                new UseCase.UseCaseCallback<CreateSavingsAccount.ResponseValue>() {
                    @Override
                    public void onSuccess(CreateSavingsAccount.ResponseValue response) {
