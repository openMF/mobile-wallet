...
⚠️ **Notice:**  
We have fully migrated to [Jetpack Compose](https://developer.android.com/jetpack/compose), and no further work on XML to Jetpack Compose conversion is required. Our primary focus is now on supporting **Kotlin Multiplatform**.
...
|:-----------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------:|
|      Android      | <img src="./docs/images/readme/android/6_home.jpg" width="120" height="210" style="margin-right:10px;"/> <img src="./docs/images/readme/android/11_RequestMoneyScanner.jpg" width="120" height="210" style="margin-right:10px;"/> <img src="./docs/images/readme/android/26_Profile.jpg" width="120" height="210"/> | <a href= "https://github.com/openMF/mobile-wallet/blob/dev/docs/readmes/Android.md">Load More</a> |
|        iOS        |       <img src="./docs/images/readme/android/2_loginScreen.jpg" width="120" height="210" style="margin-right:10px;"/> <img src="./docs/images/readme/android/6_home.jpg" width="120" height="210" style="margin-right:10px;"/> <img src="./docs/images/readme/android/30_Faqs.jpg" width="120" height="210"/>       | <a href= "https://github.com/openMF/mobile-wallet/blob/dev/docs/readmes/Android.md">Load More</a> |
|      Windows      |                                                                       <img src="./docs/images/readme/windows/5_home_screen.png" width="200" style="margin-right:10px;"/> <img src="./docs/images/readme/windows/12_History.png" width="200"/>                                                                       | <a href= "https://github.com/openMF/mobile-wallet/blob/dev/docs/readmes/Windows.md">Load More</a> |
|       Linux       |                                                                      <img src="./docs/images/readme/linux/9_PaymentSuccess.png" width="200" style="margin-right:10px;"/> <img src="./docs/images/readme/windows/31_settings.png" width="200"/>                                                                      |  <a href= "https://github.com/openMF/mobile-wallet/blob/dev/docs/readmes/Linux.md">Load More</a>  |
