...
import mobile_wallet.feature.transfer_intrabank.generated.resources.feature_send_money_no_recents
import mobile_wallet.feature.transfer_intrabank.generated.resources.feature_send_money_no_recents_subtitle
...
fun EmptyRecentsState(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.feature_send_money_no_recents),
        ...
        Text(
            text = stringResource(Res.string.feature_send_money_no_recents_subtitle),
...
@Preview
@Composable
private fun PreviewEmptyRecentsState() {
    KptMaterialTheme {
        EmptyRecentsState(
            onAddPayeeClick = {},
        )
...
@Preview
@Composable
private fun PreviewEmptyRecentsStateNoButton() {
    KptMaterialTheme {
        EmptyRecentsState()
    }
}
